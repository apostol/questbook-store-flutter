...
class _Painter extends CustomPainter {
  ...
  _Painter({required this.isLast, required this.padding, required this.avatarRoot, required this.avatarChild,required  this.pathColor, required this.strokeWidth}): _paint = Paint()
    ..color = pathColor
